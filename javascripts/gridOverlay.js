...
(function gridOverlay() {
  ...
  var page = 940,
      ...
      buttonMarkup = '<div id="gridOverlayOnOff" style="position: absolute; top: 0; right: 0; height: 12px; width: 12px; background-color: transparent; color: red; font-size: 12px; cursor: pointer;">||||</div>', 
      body = $('body');
